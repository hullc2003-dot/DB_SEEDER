# config.py - Central configuration and brain state for the AI agent
...
# Single source of truth for all 15 specialist tables.

# Import this anywhere table names are needed — never hardcode them elsewhere.

SPECIALIST_TABLES: List[str] = [
...
class LearningConfig:
    ...
    # Controls which learning sources are active
